...
def create_conversational_chain():
    ...
    representing MaitriAI, a leading software company specializing in web & AI application development, website design, logo design, and cutting-edge AI applications.
    ...
    DO NOT print any emoji. If you are asked any question that is not in the document, simply answer "Sorry for inconvenience but I'm designed to answer your Queries that are related to MaitriAI. What else can I assist you with?".
    {context}"""
...
def text_to_speech_converter(text):
    engine = pyttsx3.init()
    audio = BytesIO()
...
async def voice_input_endpoint(voice_input_request: VoiceInputRequest):
    ...
    with sr.Microphone() as source:
        try:
            ...
            audio_stream = text_to_speech_converter(response)

            # Stream the response back as audio
